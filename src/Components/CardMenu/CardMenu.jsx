      ...
      <Dialog 
        ...
        <DialogContent maxWidth sx={{padding:'0', width: "500px",}}>
          ...
          <Container maxWidth="xl" dividers={scroll === 'paper'} sx={{marginTop: '24px', borderBottom: '10px solid #FAF9FF',}}>
            ...
            <Typography sx={{ color: '#313440', fontWeight: 'bold',}}>
              Discount Price
            </Typography>
            <Typography sx={{ textDecoration:'line-through', fonSize: 12, color: '#868993'}}>
              Normal Price
            </Typography>
          ...
          <Container maxWidth="xl" sx={{marginTop: '24px', paddingBottom:'25.5px', borderBottom:'1px solid #D3D9FF'}}>
            <Box sx={{display: 'flex', justifyContent: 'space-between'}}>
              ...
              <Typography sx={{color:'#616BC8', fontSize:'14px'}}>
                *Required
              </Typography>
            </Box>
            <Typography sx={{marginTop:'4px', color:'#868993'}}>
              Select 1
            </Typography>
            <FormControl component="fieldset" sx={{marginTop:'17.5px',}}>
              <RadioGroup
                aria-label="foodChoice1"
          ...
          <Container maxWidth="xl" sx={{marginTop: '24px'}}>
            ...
            <Typography sx={{color:'#868993', marginTop:'4px'}}>
          ...
          <Box sx={{marginTop:'26px', padding:'24px', display: 'flex'}}>
            <Typography sx={{marginRight:'18px', padding:'5px', cursor:'pointer', fontSize:'20px'}} onClick={decrementCounter}>-</Typography>
            <Typography sx={{marginRight:'18px', padding:'10px', fontWeight:'bold'}}> {counter} </Typography> 
            <Typography sx={{padding:'5px', cursor:'pointer', fontSize:'20px'}} onClick={incrementCounter}>+</Typography>
            <ButtonAddCart/>
          </Box>
          </ThemeProvider>
        </DialogContent>
